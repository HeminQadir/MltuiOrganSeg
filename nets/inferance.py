...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    for slice_g in tqdm(windows_range) if progress else windows_range:
        ...
        if with_coord:
            seg_prob_out = predictor(win_data, text_embedding, unravel_slice, *args, **kwargs)  # batched patch
        else:
            seg_prob_out = predictor(win_data, text_embedding, *args, **kwargs)  # batched patch
